...
class Hospitals(models.Model):
    ...
    name = models.CharField(max_length=150)  # Field name made lowercase.
    category = models.CharField(max_length=75, blank=True, null=True)  # Field name made lowercase.
    medicine = models.CharField(max_length=75, blank=True, null=True)  # Field name made lowercase.
